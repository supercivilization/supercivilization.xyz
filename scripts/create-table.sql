...
DROP FUNCTION IF EXISTS public.create_invite(uuid, text, timestamp with time zone);
...
GRANT EXECUTE ON FUNCTION public.create_invite(UUID, TEXT, TIMESTAMP WITH TIME ZONE) TO service_role; 